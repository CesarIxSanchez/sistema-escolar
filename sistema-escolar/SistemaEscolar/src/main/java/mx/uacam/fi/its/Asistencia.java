...
public class Asistencia{
    ...
    // getters/setters y properties requeridos por TableView
    public int getIdAsistencia(){
        return idAsistencia.get();
    }
    public void setIdAsistencia(int v){
        idAsistencia.set(v);
    }
    public IntegerProperty idAsistenciaProperty(){
        return idAsistencia;
    }
    ...
    public void setIdInscripcion(int v){
        idInscripcion.set(v);
    }
