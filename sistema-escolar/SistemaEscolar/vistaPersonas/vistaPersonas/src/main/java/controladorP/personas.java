...
import MainSSH.MainSSH; // Asegúrate de que este import sea correcto
...
public class personas {
    ...
    private void onGuardar(ActionEvent event) {
        ...
        new Thread(() -> {
            try {
                ...
                int filasAfectadas = MainSSH.ejecutarComandoInsertPersona(nuevaPersona);
    ...
    private void refrescarDatos() {
        ...
        new Thread(() -> {
            try {
                MainSSH.ejecutarConexion();
                ObservableList<Persona> listaPersonas = MainSSH.ejecutarComandoSelectPersonas();
